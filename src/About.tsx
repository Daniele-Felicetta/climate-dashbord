  ...
  return (
    <div className="flex justify-evenly items-center flex-col h-[60vh]">   
      ...
      <div className='flex w-80 flex-wrap justify-evenly'>
        <a href="https://linkedin.com/in/daniele-felicetta-13a586245" target="_blank" rel="noopener noreferrer">
          <img className="w-20" src={linkedin} alt="" />
        </a>
        <a href="https://github.com/Daniele-Felicetta" target="_blank" rel="noopener noreferrer">
